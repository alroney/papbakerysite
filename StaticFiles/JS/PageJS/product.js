...
/* FORM SELECT */
    const categorySelect = document.getElementById("dogCategorySelect");
    const biscuitSelect = document.getElementById("dogBiscuitSelect");

    categorySelect.addEventListener("change", function() {
        if(this.value == "Biscuits") {
            biscuitSelect.classList.remove("d-none");
        }
        else {
            biscuitSelect.classList.add("d-none");
        }
    });
/* END OF FORM SELECT */
